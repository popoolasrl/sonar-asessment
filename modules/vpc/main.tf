...
resource "aws_vpc" "main" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-VPC-Dev" })
}
...
resource "aws_subnet" "public_subnet" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-Public-Subnet" })
}
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-Private-Subnet" })
}
...
resource "aws_subnet" "database_subnet" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-Database-Subnet" })
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-Internet-Gateway" })
}
...
resource "aws_route_table" "main" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-Public-Route-Table" })
}
...
resource "aws_lb" "main" {
  ...
  tags = merge(local.required_tags, { Name = "sonar-Application-ALB" })
}
